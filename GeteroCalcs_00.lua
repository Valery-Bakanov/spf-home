...
--
CreateTiersByEdges(  projectName .. ".gv" ) -- создать яѕ‘
...
--
AddLineToTextFrame( string.format("\n%d €рус, %d операторов, %d подъ€рус(а,ов) [вычислитель|оператор (%% исп.выч.)]:",
                                             iTier, #Tiers[iTier], subTiers ) )
AddLineToTextFrame( "=================================================================" )
--
for i=1,subTiers do -- по имеющимс€ на данном €русе подъ€русам
 outStr = string.format("п/€рус=%d: ", i)  -- строка дл€ вывода
...
-- вывод статистики по данному подъ€русу и €русу
 if i ~= subTiers then -- это Ќ≈ ѕќ—Ћ≈ƒЌ»… подъ€рус...
  ...
  AddLineToTextFrame( outStr .. string.format(" (%.1f%%); среднее по п/€русам %.1f%%",
                                         100 * calcsUsedSubTier / nCalcs,
