--
-- крива€ Ћоренца и неравномерность на еЄ основе;  2021 
--
...
--
OutLine( string.format("\n оэффициент неравномерности= %g (%g)", ICL,CalcParamsTiers(6) )) 
--                                                                                                                
return ICL
--
...
--
f_ICL() -- вычисление кривой Ћоренца и коэффициента неравномерности распределени€ ICL
--
