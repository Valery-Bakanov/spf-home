...
--[[
LuaCallByTimer("Fun(5); SoundPlay('cuckoo.wav');",5) --------------------------------------------------------------------------------------
LuaCallByTimer("Fun(15); SoundPlay('goodbye.wav');",15) --------------------------------------------------------------------------------------
--LuaCallByTimer("Fun(101); SoundPlay('pig.wav');",10) --------------------------------------------------------------------------------------
LuaCallByTimer("Fun(101);",10)
--LuaCallByTimer("Fun(102); SoundPlay('rooster.wav');",10) --------------------------------------------------------------------------------------
LuaCallByTimer("Fun(102);",10) --------------------------------------------------------------------------------------
--LuaCallByTimer("Fun(103); SoundPlay('dog1.wav');",10) --------------------------------------------------------------------------------------
LuaCallByTimer("Fun(103);",10) --------------------------------------------------------------------------------------
--]]
for i=1,1000 do -- по по вызовам LuaCallByTimer
 LuaCallByTimer("Fun(" .. i .. ");", 10) --------------------------------------------------------------------------------------
end
--
--[[
for i=1,10 do -- по по вызовам LuaCallByTimer
 LuaCallByTimer("Fun(" .. i .. ");",i) --------------------------------------------------------------------------------------
end
--]]
