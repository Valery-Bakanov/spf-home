-- стратегия WidthByWidth  (ноябрь 2017)
--
...
ClearTextFrame()
--
WidthMax = 10 -- max ширина ЯПФ
WidthMax = tonumber ( InputDialog( "Предельная ширина ЯПФ ", "Вводите целое больше нуля как строку", tostring( WidthMax  )))
