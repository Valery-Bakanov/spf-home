...
TF1 *F1;
//
//#include "pcre.h" // библиотека регулярных выражений
//
//#define INT unsigned int // тип целых без знака ( 32 бита = 4 байта; диапазон 0-4'294'967'296 )
//#define INT  int // тип целых со знаком ( 32 бита = 4 байта; диапазон +/- 2'147'483'647 )
...
float AveIn, AveOut; // среднее число входов и выходов
...
//
char TitleF2[_256] = " Область текстового представления информации"; // заголовок F2
//
...
char ScriptFileName[_256]  = "noname.lua", // текущее имя файла Lua-скрипта
     ...
     extTiers[] = ".trs", // расширение имени файла ЯПФ
     ...
     extDlg[]   = ".dlg", // расширение имени файла времени жижни данных
     extVisu[]  = "_vz",  // дополнение к расширению имени файла для Visu
...
////////////////////////////////////////////////////////////////////////////////
bool PutParamsTiersOnTextFrame = FALSE; // надо ли выводить параметры ЯПФ в текстовый фрейм
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
float partHeightStdout[3] = {0.2, 0.1, 0.5}; // доля высоты окна stdout (текущая, min, мах)
////////////////////////////////////////////////////////////////////////////////
...
//
  ...
  c_ClearDiagrTiers(); // очистить графическое представление ЯПФ
...
{ // F6 -построить и выдать в текстовое окно диаграмму жизни данных ------------
 c_CreateAndOutputDataLiveDiagrByTiers( 0, "" ); // создать диагр.времени жизни данных по текущ.Tiers[][]
} //----------------------------------------------------------------------------
