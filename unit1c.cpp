...
#include "vcl/dstring.h" // для описания Length и др.
//
...
// ----- цвета для очистки диаграммы распр.операторов по ярусам ЯПФ и TLD
...
//
     extGv[]    = ".gv",  // расширение имени файла дуг графа для ввода (вывод/ввод, ".")
     extVizu[]  = "_vz",  // дополнение к расширению имени файла для Vizu (вывод/ввод, без ".")
     extTiers[] = ".trs", // расширение имени файла ЯПФ (вывод, ".")
     extIno[]   = ".ino", // расширение имени файла ЯПФ (вывод, ".")
     extPrm[]   = ".prm", // расширение файла параметров ЯПФ (вывод, ".")
...
char busy_CommandLine[_512]; // выполняющаяся в данный момент Lua-строка
//
////////////////////////////////////////////////////////////////////////////////
...
{ // показывает сообщение... пока не используется..!
...
////////////////////////////////////////////////////////////////////////////////
 ...
 for( i=1; i<=c_GetCountOutEdgesByOp(Op); i++ ) // цикл по всем ВЫХОДяЩИМ дугам данного оператора
 {
  snprintf( tmp,sizeof(str), " %d/%d", c_GetNumbOutEdgeByOp(i,Op),
                                       c_GetTierByOp(c_GetNumbOutEdgeByOp(i,Op)) ); // оператор/ярус
