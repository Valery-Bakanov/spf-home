...
char ScriptFileName[_256]  = "noname.lua", // текущее имя файла Lua-скрипта
     ...
     extTiers[] = "trs", // расширение имени файла ЯПФ (без ".", ибо TStringList)
     ...
     extTld[]   = "tld", // расширение имени файла времени жизни данных  (без ".", ибо TStringList)
     extVisu[]  = "_vz", // дополнение к расширению имени файла для Visu (без ".", ибо TStringList)
