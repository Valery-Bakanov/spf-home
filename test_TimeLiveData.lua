...
local Op1=103
local Op2=101
w=string.format("%d %d",Op1,Op2)  -- исходная строка
print(w)
w=InputDialog("Два оператора для обмена","Введи два целых черех пробел",w)
string.format(w, "%d %d", Op1,Op2) -- форматное чтение
--
print(Op1)
print(Op2)
OutLine("\n\nOp1= "..Op1.."<->".."Op2= "..Op2)
--
SwapOpsTierToTier(Op1,Op2)  -- обмен операторов 
--
Visual() -- визуализация состояния ЯПФ
--
DelayMS(100)
