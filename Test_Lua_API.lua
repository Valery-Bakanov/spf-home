...
--
OutLine( "\nВсего вершин в графе (без входного яруса)= " .. GetCountOps() )
OutLine( "Всего дуг в графе= " .. GetCountEdges() )
--
OutLine( "\nЧисло входных (исходные данные) вершин= " .. GetCountOpsInput() .. " ; см. список ниже:"  )
for i=1,GetCountOpsInput()  do
 OutLine(  "#" .. i .. ". Вершина: " .. GetNumbOpInput(i)  )
end
--                                                                                                          
OutLine( "\nЧисло выходных (результаты выполнения) вершин= " .. GetCountOpsOutput() .. " ; см. список ниже:" )
for i=1,GetCountOpsOutput()  do
 OutLine(  "#" .. i .. ". Вершина: " .. GetNumbOpOutput(i)  )
end
--
Op=106-- исследуем окружение вершины Op
--
OutLine( "\nТтестируем окружение вершины  " .. Op  )
OutLine( "==============================" )
--
